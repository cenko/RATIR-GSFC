...
;	those beyond saturation and count limits).  Then takes sigma clipped median of each pixel and save
;	as with outfile name.
;
; INPUT:
...
pro skypipecombine, filelist, outfile, removeobjects=removeobjects, objthresh=objthresh, $
