...
pro pzap_perley, name, outname, outmaskname, nsigma=nsigma, subsigma=subsigma, preiter=preiter, postiter=postiter, $
...
saturation=saturation
   ...
   if keyword_set(verbose) then print, '  sky = ', strtrim(string(skylevel),2), ' (sigma = ', strtrim(string(sigval),2), ', saturation = ', strtrim(long(satlevel),2),')'
