...
SEEING_FWHM      1.8            # stellar FWHM in arcsec
...
#          12345678901234567890123456789012345678901234567890123456789012345678901234567890
    ...
    print "      -c  catalog:     Catalog to use (tmpsc, ub2, tmc, sdss, or file: see --catalog)"
...
def main():
    ...
    for filename in filenames:
        ...
        print userra
        print userdec
        fitinfo = autoastrometry(filename,pixelscale=pixelscale,pa=pa,inv=inv,uncpa=uncpa,minfwhm=minfwhm,maxfwhm=maxfwhm,maxellip=maxellip,boxsize=boxsize, maxrad=maxrad, userra=userra, userdec=userdec, tolerance=tolerance, catalog=catalog, nosolve=nosolve, overwrite=overwrite, outfile=outfile, saturation=saturation, quiet=quiet)
        if nosolve: continue
        if type(fitinfo)==int: 
           fitinfo = (0,0,0,0,0,0)
